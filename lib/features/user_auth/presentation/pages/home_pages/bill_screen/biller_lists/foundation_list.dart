...
class FoundationListPage extends StatelessWidget {
  final String categoryName;

  FoundationListPage({required this.categoryName});
  ...
  final Map<String, String> billerInitials = {
    'DAUGTHERS OF ST PAUL': 'D',
    'GMA KAPUSO FOUNDATION': 'G',
    'JOLIBEE FOUNDATION': 'J',
    'RED CROSS': 'R',
    'UNICEF': 'U',
  };
