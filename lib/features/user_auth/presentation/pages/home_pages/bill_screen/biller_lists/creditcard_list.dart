...
class CreditCardListPage extends StatelessWidget {
  ...
  CreditCardListPage({required this.categoryName});

  final Map<String, List<String>> billersByCategory = {
    'Credit Cards': [
      'BDO CREDIT CARD',
      'EQUICOM SAVINGS',
      'METROBANK/PS BANK MASTER CARD',
  ...
  final Map<String, String> billerInitials = {
    'BDO CREDIT CARD': 'B',
    'EQUICOM SAVINGS': 'E',
    'METROBANK/PS BANK MASTER CARD': 'M',
    'SECURITY BANK CREDIT CARDS': 'S',
    'UNION BANK OF THE PHILIPPINES': 'U',
  };
