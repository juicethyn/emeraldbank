...
class LogisticsListPage extends StatelessWidget {
  final String categoryName;

  LogisticsListPage({required this.categoryName});

  final Map<String, List<String>> billersByCategory = {
    'Logistics': [
      'KMTC PHILIPPINES CORPORATION',
      'MEDLOG PHILIPPINES INC',
      'SKY INTL-INVOICE',
    ],
  };

  final Map<String, String> billerInitials = {
    'KMTC PHILIPPINES CORPORATION': 'K',
    'MEDLOG PHILIPPINES INC': 'M',
    'SKY INTL-INVOICE': 'S',
  };
