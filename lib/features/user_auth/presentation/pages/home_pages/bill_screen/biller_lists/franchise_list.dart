...
class FranchiseListPage extends StatelessWidget {
  final String categoryName;

  FranchiseListPage({required this.categoryName});

  final Map<String, List<String>> billersByCategory = {
    'Franchises': [
      'INNOVENTION FOOD RESOURCES INC',
      'PHOENIX PETROLEUM',
  ...
  final Map<String, String> billerInitials = {
    'INNOVENTION FOOD RESOURCES INC': 'I',
    'PHOENIX PETROLEUM': 'P',
    'RED RIBBON BAKESHOP INC.': 'R',
    'SEAOIL PHILIPPINES INC': 'S',
  };
